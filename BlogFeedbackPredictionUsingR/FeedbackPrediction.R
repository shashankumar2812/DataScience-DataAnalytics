...
"AIC of both the logistic models suggest there is no significant imporvment after removing colinear features."
...
"Need to remove following columns and rerun the Linear and Logistic models:
